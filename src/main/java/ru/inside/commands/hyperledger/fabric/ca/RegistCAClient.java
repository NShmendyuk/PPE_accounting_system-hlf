...
public class RegistCAClient {
    ...
    public void initializeUsersCA(String HLF_USER_NAME) {
        ...
        try {
            ...
            CAAuthAdmin.enrollAdmin(HLF_PATH_ORG_CONNECTION, HLF_PEER_GRPC_URL, HLF_ADMIN_NAME, HLF_ADMIN_PASS,
                    HLF_ORG_MSP_ID, HLF_HOST_PEER_IP);
            log.info("admin enrolled");
            CAAuthUser.enrollUser(HLF_PATH_ORG_CONNECTION, HLF_PEER_GRPC_URL, HLF_USER_NAME, HLF_ADMIN_NAME,
